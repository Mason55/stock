...
### 📈 量化交易
- [策略开发指南](docs/trading/STRATEGY_GUIDE.md) - 策略开发、回测、实盘完整教程
- [实盘交易指南](docs/trading/LIVE_TRADING.md) - 实盘系统架构与使用
- [券商对接文档](docs/trading/BROKER_INTEGRATION.md) - 券商API对接指南

### 🏗️ 系统架构
- [系统架构说明](docs/ARCHITECTURE.md) - 技术架构详解
- [产品路线图](docs/ROADMAP.md) - 功能规划和发展方向
- [部署指南](docs/DEPLOYMENT.md) - 生产环境部署
- [监控指南](docs/MONITORING_GUIDE.md) - 系统监控和告警
...
### v2.1（2025-11-22）⭐ 当前版本
- ✅ 文档重构 - 精简文档从42个到12个核心文档
- ✅ ETF专项分析 - 溢价率/跟踪误差/持仓分析
- ✅ 持久化缓存系统 - SQLite缓存，避免API限流
- ✅ 历史数据ETL - 自动化数据采集和指标计算
- ✅ 增强指标系统 - 布林带/KDJ/ATR及解释引擎
...
完整更新日志请查看 [CHANGES.md](CHANGES.md)
